                        ...
                        <div className="relative skew-y-[1deg] w-full">
                            ...
                            <div className=" flex items-center justify-between flex-col 580px:flex-row">
                                <div className='text-center 580px:text-left'>
                                    <h2 className="text-6xl md:text-7xl uppercase lg:text-8xl  text-black mb-2">
                                        {t("aboutMojo")}
                                    </h2>
                                    <p className="max-w-full 580px:max-w-xs md:max-w-md lg:max-w-xl text-sm font-secondary md:text-base xl:text-xl text-black leading-6 ">
