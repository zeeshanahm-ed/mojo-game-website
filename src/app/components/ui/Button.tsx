    ...
    ({
        ...
        return (
            <button
                ...
                type={type}
                {...rest}
                className={`bg-purple text-white boxShadow-custom pt-3 pb-2 px-6 transform -skew-x-12 border-2 border-black shadow-lg hover:bg-purple transition-colors duration-300 ${variant} ${className}`}
                aria-label="Login"
            >
                {prefixElement}
                {children}
