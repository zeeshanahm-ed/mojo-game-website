        ...
        <header className="w-full overflow-hidden font-sans h-20 flex items-center px-10">
            <nav className="flex items-center justify-between w-full p-4">
                ...
                <div className="flex items-center space-x-8 text-gray-800 text-lg font-medium w-fit text-nowrap">
                    <Link href="#" className="hover:text-dark-gray transition-colors">{t("my_games")}</Link>
                    <Link href="#" className="hover:text-dark-gray transition-colors">{t("contact_us")}</Link>
                    <LanguageSwitcher />
                </div>
            </nav>
            <AuthModal />
