                ...
                {step === 1 ?
                    <div className="w-full pb-10 pt-5  space-y-5 h-auto max-h-[800px] font-secondary">
                        ...
                        <div className='px-4 md:px-10 space-y-5 overflow-y-auto h-auto max-h-[500px]'>
                            <button onClick={handleGoToAddQuestion} className='w-full hover:text-light-gray transition-colors duration-300 -skew-x-6 md:-skew-x-12 flex justify-between items-center py-4 px-4 md:px-8 border border-black'>
                            ...
                            {questionsData?.map((question, index) => (
                                <button key={index} onClick={() => handleEditQuestion(index)} className='w-full hover:text-light-gray transition-colors duration-300 -skew-x-6 md:-skew-x-12 flex justify-between items-center py-4 px-4 md:px-8 border border-black'>
