...
export default function GameExitModal({ open, closeModal }: GameExitModalProps) {
                ...
                <div className='px-5 md:px-10 py-10'>
                    <div className="text-center space-y-6">
                        ...
                        <div className='flex justify-evenly '>
                            ...
                            <Button className='md:text-5xl text-2xl w-32 md:w-44' onClick={handleExitGame}>{t('yes')}</Button>
                        </div>
                    </div>
                </div>
            </div>
