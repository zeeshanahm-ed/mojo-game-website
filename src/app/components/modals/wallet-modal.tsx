    ...
    return (
        <dialog id="wallet_modal" className={` modal ${open ? 'modal-open' : ''}`}>
            <div className="max-w-4xl modal-box bg-white items-center rounded-none border-2 border-black">
                ...
                {/* Wallet Content */}
                <div className="flex flex-col md:flex-row items-baseline w-full justify-between gap-8 py-8 px-4 font-popfun">

                    {/* Game Credits Card */}
                    <div className="flex flex-col items-start gap-4">
                        <div className="w-20 md:w-28 md:h-1/2 relative">
                            <Image src={CreditImage} alt='Credits' className='w-full h-full' />
                        </div>

                        <h3 className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl">
                            10 GAME CREDITS
                        </h3>
                        <p className="text-sm max-w-xs font-Product_sans">
                            These game credits will be used for creating games.
                        </p>
                        <Button className='text-3xl w-48' onClick={() => handleNavigate("recharge")}>
                            RECHARGE WALLET
                        </Button>
                    </div>
                    ...
                    {/* SAR Currency Card */}
                    <div className="flex flex-col items-start gap-4">
                        <div className="w-20 md:w-24 md:h-1/2 relative">
                    ...
                    {/* History Card */}
                    <div className="flex flex-col items-start gap-4">
                        <div className="w-20 md:w-16 md:h-1/2 relative">
                        ...
                        <Button className='text-3xl w-48' onClick={() => handleNavigate("history")}>
                            VIEW HISTORY
                        </Button>
                    </div>
                </div>
